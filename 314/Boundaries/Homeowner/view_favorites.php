...
$favorites = $favoriteController->getFavoritesByHomeowner($homeownerId);

if ($keyword !== '') {
    $keyword = strtolower($keyword);
    $favorites = array_filter($favorites, function ($favorite) use ($keyword) {
        return str_contains(strtolower($favorite['name']), $keyword) ||
               str_contains(strtolower($favorite['category_name']), $keyword);
    });
}
?>
        ...
        <div class="favorites-container">
            <?php foreach ($favorites as $favorite): ?>
                <div class="favorite-card">
                    ...
                    <a class="remove-btn"
                       href="remove_favorite.php?cleaner_id=<?= $favorite['id'] ?>"
