...
if ($keyword) {
    $cleaners = $cleanerController->searchCleanersByCategoryOrRating($keyword);
} else {
    $cleaners = $cleanerController->getAllActiveCleaners();
}
?>
...
<div class="search-bar">
    <form method="GET" style="display: flex; gap: 10px;">
        <input type="text" name="search" placeholder="Search by category, rating, or location" value="<?= htmlspecialchars($keyword) ?>">
...
<div class="cleaner-list">
    <?php foreach ($cleaners as $cleaner): ?>
        <?php $isFavorited = $favoriteController->isFavorited($homeownerId, $cleaner['user_id']); ?>
        <div class="cleaner-card">
            <div class="cleaner-details">
                ...
                <p><strong>Category:</strong> <?= htmlspecialchars($cleaner['category_name']) ?></p>
            ...
            <div class="actions">
                ...
                <?php else: ?>
                    <a class="favorite-btn" href="favorite_cleaner.php?cleaner_id=<?= $cleaner['user_id'] ?>">Favorite</a>
                <?php endif; ?>
                <a class="view-btn" href="../Admin/view_cleaner_profile.php?id=<?= $cleaner['user_id'] ?>">View Profile</a>
            </div>
        </div>
    <?php endforeach; ?>
</div>
