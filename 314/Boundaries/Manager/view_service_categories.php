...
$keyword = $_GET['search'] ?? '';
$categories = $keyword 
    ? $controller->searchCategories($keyword) 
...
<head>
    ...
    <style>
        body {
            ...
            background: url('../img/view_service.jpg') no-repeat center center;
            ...
            <?php foreach ($categories as $category): ?>
                <tr>
                   ...
                   <td data-label="Action">
						...
						<?php else: ?>
							<a href="unsuspend_category.php?id=<?= $category['category_id'] ?>" class="remove-btn unsuspend" onclick="return confirm('Unsuspend this category?');">Unsuspend</a>
						<?php endif; ?>
						</div>
					</td>
                </tr>
