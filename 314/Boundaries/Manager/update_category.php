...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($newName) && !empty($newDescription)) {
        if ($controller->updateCategory($categoryId, $newName, $newDescription)) {
...
<div class="container">
    ...
    <fieldset>
        ...
        <input type="text" value="<?= $category['category_id'] ?>" readonly>

        <label>Current Name:</label>
        <input type="text" value="<?= htmlspecialchars($category['name']) ?>" readonly>

        <label>Current Description:</label>
        <input type="text" value="<?= htmlspecialchars($category['description']) ?>" readonly>
    </fieldset>
