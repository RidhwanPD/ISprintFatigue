...
$profile = $controller->getCleanerProfileByUserId($userId);

$serviceCategoryController = new ServiceCategoryController();
$categories = $serviceCategoryController->getAllCategories();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($controller->updateCleanerProfile($userId, $phone, $address, $experience, $preferredCleaningTime, $cleaningFrequency, $languagePreference, $expertise, $rating)) {
