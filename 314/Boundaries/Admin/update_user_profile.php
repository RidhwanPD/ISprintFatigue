...
$profile = $controller->getProfileByUserId($userId);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($controller->updateProfile($userId, $phone, $address, $preferredCleaningTime, $cleaningFrequency, $languagePreference)) {
