...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $controller->updateUser($id, $newName, $newEmail, $newRole);
...
<body>
    <div class="form-container">
        <h2><i class="fas fa-user-edit"></i> Update User: ID <?= $user['id'] ?></h2>
        ...
        <fieldset>
            ...
            <label>Email:</label>
            <input type="email" value="<?= $user['email'] ?>" class="readonly" readonly>

            <label>Role:</label>
            <input type="text" value="<?= ucfirst($user['role']) ?>" class="readonly" readonly>
        </fieldset>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <select name="role" required>
                        ...
                        <option value="manager" <?= ($_POST['role'] ?? '') === 'manager' ? 'selected' : '' ?>>Platform Manager</option>
                    </select>
                </div>
